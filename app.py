...
tab1, tab2, tab3 = st.tabs(["説明", "全体", "詳細"])
with tab1:
    st.markdown(
        """
        ### 使い方
        - 本ダッシュボードは、東京都警察の公開テータを使用しています。
        - ダッシュボードは、全体の概要ダッシュボードと被害者属性等の詳細ダッシュボードに分かれており、画面上部のタブで切り替えられます。
        - サイドバーのデータフィルターでは、特定の手口や、区が選択できます。
        ...
        ### ソースコードについて
        本アプリケーションのソースコードはgithub上で公開しております
        - アプリケーション:https://github.com/koy0208/crime-visualizer
        - データの加工:https://github.com/koy0208/dbt-crime-visualizer
